...
<body>
	<section id="main-content">
		<section class="wrapper">
			<h3>
				<i class="fa fa-angle-right"></i> 책방 등록
			</h3>
			<div class="row mt">
				<!--  폼 시작 -->
				<div class="col-lg-12">
					<div class="form-panel">
						<form role="form" method="post" class="form-horizontal style-form">
							...
							<div class="form-group">
								...
								<label class="col-sm-2 col-sm-2 control-label">책방 이름</label>
								<div class="col-sm-10">

									<input type="text" class="form-control" name='bookstoreTitle'
							...
							<div class="form-group">
								...
								<div class="col-sm-10">
									...
									<input type="text" class="form-control" name='bookstoreContent'
										style="width: 328px; margin-left: 68px;">
								</div>
							</div>
							...
							<div class="form-group">
								...
								<div class="col-sm-10">
									...
									<input type="text" class="form-control" name='bookstoreUrl'
										style="width: 328px; margin-left: 68px;">
								</div>
							</div>
							...
							<div class="btn-group btn-group-justified">
								...
								<div class="btn-group">
									<button type="button" class="btn btn-theme03">목록으로
										돌아가기</button>
								</div>
							</div>
						</form>
