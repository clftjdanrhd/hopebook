   ...
   <section class="wrapper">
      <div class="row mt">
         ...
         <div class="col-md-12">
            ...
            <!-- /.box-header -->
            <h3>
               <i class="fa fa-angle-right"></i>세금계산서 작성
            </h3>
               ...
               <div class="form">
                  <form class="cmxform form-horizontal style-form" method="post">
                     ...
                     <div class="form-group ">
                        <label for="firstname" class="control-label col-lg-2">성함</label>
                        <div class="col-lg-10">
                     ...
                     <div class="form-group ">
                        <label for="firstname" class="control-label col-lg-2">이메일</label>
                        <div class="col-lg-10">
                     ...
                     <div class="form-group ">
                        <label for="firstname" class="control-label col-lg-2">전화번호</label>
                        <div class="col-lg-10">
                           <input class=" form-control round-form le" id="firstname"
                              name="taxPhone" type="text" />
                        </div>
                     </div>
                     ...
                     <div class="form-group">
                        <input class="form-control" style="width: 40%; display: inline;"
                           placeholder="우편번호" name="taxAdr1" id="taxAdr1" type="text"
                           readonly="readonly">
                     ...
                     <div class="form-group ">
                        <label for="firstname" class="control-label col-lg-2">메세지</label>
                        <div class="col-lg-10">
