					...
					<div class="box-body">
						<div class="form-group">
							<label for="exampleInputEmail1">bookstoreNum</label> <input type="text"
								name='bookstoreNum' class="form-control" placeholder="Enter Title">
						</div>
						<div class="form-group">
							<label for="exampleInputEmail1">bookstoreTitle</label> <input type="text"
								name='bookstoreTitle' class="form-control" placeholder="Enter Title">
						</div>
						<div class="form-group">
							...
							<label for="exampleInputEmail1">bookstoreUrl</label> <input type="text"
								name='bookstoreUrl' class="form-control" placeholder="Enter Title">
						</div>
