...
<section id="main-content">
   <section class="wrapper">
      ...
      <div class="row mt">
         <div class="col-lg-12">
            <h4>
               <i class="fa fa-book"></i>자유게시판 상세보기
            </h4>
            <div class="form-panel form-horizontal style-form">
               <div class="form">
                  <form role="form" action="modifyPage" method="post">
								<input type='hidden' name='metBrdNum' value="${metBoardVO.metBrdNum}"
				id="metBrdNum"> <input type='hidden' name='metBrdMemNum'
				value="${metBoardVO.memNum}" id="metBrdMemNum"> <input
				...
				type='hidden' name='keyword' value="${cri.keyword}">
                  ...
                  <div class="form-group ">
                     <div class="col-lg-4">
                     <label for="firstname" class="control-label col-lg-4">분류</label>
                     </div>
                     <div class="col-lg-6">
                     <label for="firstname" class="control-label col-lg-6">${metBoardVO.metBrdCategory}</label>
                     </div>
                  </div>
                  <div class="form-group ">
                     <div class="col-lg-4">
                     <label for="firstname" class="control-label col-lg-4">조회수</label>
                     </div>
                     <div class="col-lg-6">
                     <label for="firstname" class="control-label col-lg-6">${metBoardVO.metBrdCount}</label>
                     </div>
                  </div>
                  ...
                  <div class="form-group ">
                     <div class="col-lg-4">
                     <label for="lastname" class="control-label col-lg-4">제목</label>
                     </div>
                     <div class="col-lg-6">
                           <label for="firstname" class="control-label col-lg-12">${metBoardVO.metBrdName}</label>
                        </div>                        
                  </div>
                  <div class="form-group ">
                     <div class="col-lg-4">
                     ...
                     <div class="col-lg-6">
                           <label for="firstname" class="control-label col-lg-12">${metBoardVO.metBrdContent}</label>
                        </div>                        
                  </div>
                     ...
                     <div class="form-group ">
                        ...
                        <div class="col-lg-6">
                           <label for="firstname" class="control-label col-lg-6">${metBoardVO.memName}</label>
                        </div>
                     </div>
                  ...
                  <div class="form-group">
                     ...
                     <div class="col-lg-10">
                        <div class="col-lg-offset-2 col-lg-10">
                           ...
                           <c:if test="${member.memNum eq MeetingVO.memNum}">
...
<script>
	$(document).ready(function() {
		...
		$(".btn-warning").on("click", function() {
			formObj.attr("action", "/metboard/metmodify");
			formObj.attr("method", "get");
			formObj.submit();
		});

		$(".btn-danger").on("click", function() {
			formObj.attr("action", "/metboard/removePage");
			formObj.submit();
		});

		$(".btn-primary").on("click", function() {
			formObj.attr("method", "get");
			formObj.attr("action", "/metboard/metbrdreadlist");
			formObj.submit();
		});
