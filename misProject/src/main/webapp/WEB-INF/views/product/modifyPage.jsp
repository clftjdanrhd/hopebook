					...
					<div class="box-body">
						...
						<div class="form-group">
							<label for="exampleInputEmail1">PNO</label> <input type="text"
								name='pno' class="form-control" value="${productVO.pno}"
								readonly="readonly">
						</div>

						<div class="form-group">
							<label for="exampleInputEmail1">Title</label> <input type="text"
								name='title' class="form-control" value="${productVO.title}">
						</div>
						
						<div class="form-group">
							<label for="exampleInputEmail1">Price</label> <input type="text"
								name='title' class="form-control" value="${productVO.price}">
						</div>
						<div class="form-group">
