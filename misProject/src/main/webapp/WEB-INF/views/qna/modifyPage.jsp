...
<section id="main-content">
      ...
      <div class="row mt">
          <div class="col-lg-12">
            <h4><i class="fa fa-angle-right"></i>문의글 수정</h4>
...
<input type='hidden' name='qNum' value="${qnAVO.qNum}">
	...
	<input type='hidden' name='keyword' value="${cri.keyword}">
                      <input class=" form-control" id="firstname" name="title" value="${qnAVO.title}" type="hidden" />
                  
                   <div class="form-group ">
                    <label for="firstname" class="control-label col-lg-2">제목</label>
                    <div class="col-lg-10">
                      <input class=" form-control round-form le" id="firstname" name="title" type="text" value="${qnAVO.title}" />
                    </div>
                  </div>
                   ...
                   <div class="form-group ">
                    ...
                    <div class="col-lg-10">
                      <textarea class="form-control le" rows="4" id="username" name="content" type="text" >${qnAVO.content }</textarea>
                    </div>
                  </div>
