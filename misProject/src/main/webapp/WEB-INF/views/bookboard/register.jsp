				...
				<form class="cmxform form-horizontal style-form" method="post"
					...
					<div class="form-panel">
						...
						<div class="form-group ">
							...
							<div class="col-lg-10">
								<input class=" form-control round-form le" id="lastname"
									name="bookBrdTitle" type="text" />
							</div>
						</div>
						<input type="hidden" name='bookNum' class="form-control"
							readonly="readonly" value="${bookVO.bookNum}">
						<div class="form-group ">
							<label for="username" class="control-label col-lg-2">책 제목</label>
							<div class="col-lg-10">
								<input type="text" class="form-control round-form"
									name="bookTitle" id="bookTitle" readonly="readonly"
									style="width: 300px;" placeholder="책을 선택해주세요."> <a
									href='#'
									onClick="window.open('/bookboard/searchPopup', 'CLIENT_WINDOW',
						...
						<div class="form-group ">
							...
							<div class="col-lg-10">
								<input class=" form-control round-form le" id="username"
									name="writer" value="${bookVO.writer}" type="text" />
							</div>
						</div>
						<div class="form-group ">
							...
							<div class="col-lg-10">
								<input class=" form-control round-form le" id="username"
									name="publisher" type="text" readonly="readonly"
						...
						<div class="form-group">
							<div class="col-lg-offset-2 col-lg-10">
								<button class="btn btn-theme btn-round" type="submit">Save</button>
								<button class="btn btn-theme04 btn-round" type="button">Cancel</button>
							</div>
						</div>
					</div>
