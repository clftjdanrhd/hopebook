...
<section id="main-content">
      ...
      <div class="row mt">
          <div class="col-lg-12">
            <h4><i class="fa fa-angle-right"></i>이달의 책 수정</h4>
	...
	<input type='hidden' name='keyword' value="${cri.keyword}">
                      <input class=" form-control" id="firstname" name="bookBrdNum" value="${bookBoardVO.bookBrdNum }" type="hidden" />
                  
                   <div class="form-group ">
                    <label for="firstname" class="control-label col-lg-2">제목</label>
                    <div class="col-lg-10">
                      <input class=" form-control round-form le" id="firstname" name="bookBrdTitle" type="text" value="${bookBoardVO.bookBrdTitle }" />
                    </div>
                  </div>
                  <div class="form-group ">
                    <label for="lastname" class="control-label col-lg-2">책 제목</label>
                    <div class="col-lg-10">
                      <input class=" form-control round-form le" id="lastname" name="bookBrdContent" type="text" value="${bookBoardVO.bookTitle }" />
                    </div>
                  </div>
                  <div class="form-group ">
                    <label for="username" class="control-label col-lg-2">저자</label>
                    <div class="col-lg-10">
                      <input class="form-control round-form le" id="username" name="publisher" type="text" value="${bookBoardVO.writer }" />
                    </div>
                  </div>
                  ...
                  <div class="form-group ">
                    ...
                    <div class="col-lg-10">
                      <input class="form-control round-form le" id="username" name="publisher" type="text" value="${bookBoardVO.publisher }" />
                    </div>
                  </div>
                  <div class="form-group ">
                    <label for="username" class="control-label col-lg-2">내용</label>
                    <div class="col-lg-10">
                      <textarea class="form-control le" rows="4" id="username" name="bookBrdContent" type="text" >${bookBoardVO.bookBrdContent }</textarea>
                    </div>
                  </div>
