      ...
      <div class="row mt">
         ...
         <div class="row mt">
            ...
            <div class="col-lg-12">
               ...
               <form role="form" action="modifyPage" name="frm"
                  ...
                  <div class="form-panel">
                     <div class=" form">
                        ...
                        <input type='hidden' name='noticeNum'
                           value="${noticeVO.noticeNum}">

                        <div class="box-body">

                           <div class="form-group ">
                              <label for="lastname" class="control-label col-lg-2">작성자</label>
                              <div class="col-lg-10">
                                 <input class="form-control round-form le" id="cname"
                                    name="memName" type="text" value="${member.memName}" />
                              </div>
                           </div>
                           ...
                           <div class="form-group ">
                              ...
                              <div class="col-lg-10">
                                 <textarea class="form-control  le" name="noticeContent"
                                    rows="3">${noticeVO.noticeContent }</textarea>
                              </div>
                           </div>
